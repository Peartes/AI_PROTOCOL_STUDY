...
const (
	RaftServer_RequestVote_FullMethodName = "/raft.types.RaftServer/RequestVote"
)
...
func (c *raftServerClient) RequestVote(ctx context.Context, in *RequestVoteRequest, opts ...grpc.CallOption) (*RequestVoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RequestVoteResponse)
	err := c.cc.Invoke(ctx, RaftServer_RequestVote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRaftServerServer) RequestVote(context.Context, *RequestVoteRequest) (*RequestVoteResponse, error) {
...
func _RaftServer_RequestVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestVoteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServerServer).RequestVote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftServer_RequestVote_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServerServer).RequestVote(ctx, req.(*RequestVoteRequest))
	}
...
var RaftServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "raft.types.RaftServer",
	HandlerType: (*RaftServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RequestVote",
			Handler:    _RaftServer_RequestVote_Handler,
		},
	},
